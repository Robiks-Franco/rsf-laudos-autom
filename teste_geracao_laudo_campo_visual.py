"""
=================================================================
 Teste de ponta a ponta — Campo Visual (Octopus 600, Haag-Streit)
 (SEM precisar de PDFs reais nem de chave de API)
=================================================================

Igual a "teste_geracao_laudo.py" (Zeiss), "teste_geracao_laudo_nidek.py"
(Nidek) e "teste_geracao_laudo_pentacam.py" (Pentacam), mas usando a
configuração e o template de Campo Visual (Octopus 600), com dados
fictícios (arquivo dados_exemplo_campo_visual.json).
...
Rode com:
    python exemplo/teste_geracao_laudo_campo_visual.py
...
# pelo Octopus 600 (um para OD, outro para OE).
NOMES_ARQUIVOS_SIMULADOS = [
    "PACIENTE_EXEMPLO_OD_10082026.pdf",
    "PACIENTE_EXEMPLO_OS_10082026.pdf",
]


def main():
    print("=" * 70)
    print("TESTE DE PONTA A PONTA — Laudo Campo Visual Octopus 600 (dados fictícios)")
    print("=" * 70)

    caminho_config = PASTA_PRINCIPAL / "config_campo_visual.json"
    caminho_template = PASTA_PRINCIPAL / "template_laudo_campo_visual.docx"
    caminho_dados_exemplo = PASTA_EXEMPLO / "dados_exemplo_campo_visual.json"

    caminho_docx_saida = PASTA_EXEMPLO / "laudo_exemplo_campo_visual.docx"
    caminho_json_saida = PASTA_EXEMPLO / "laudo_exemplo_campo_visual_dados.json"
    ...
    try:
        ...
        print("\n" + "=" * 70)
        print("SUCESSO! O laudo de Campo Visual está funcionando corretamente.")
        ...
        print(
            ...
            "de Campo Visual, use a interface gráfica (main.py) ou o aplicativo "
            "web, escolhendo 'Octopus 600 (Haag-Streit) — Campo Visual' no "
