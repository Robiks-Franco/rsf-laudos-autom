"""
=================================================================
 Teste de ponta a ponta — equipamento Nidek RS-3000 Advance
 (SEM precisar de PDFs reais nem de chave de API)
=================================================================

Igual a "teste_geracao_laudo.py" (que testa o equipamento Zeiss
Cirrus), mas usando a configuração e o template do Nidek RS-3000
Advance, com dados fictícios (arquivo dados_exemplo_nidek.json).
...
Rode com:
    python exemplo/teste_geracao_laudo_nidek.py
...
# de protocolo — em um uso real, esses seriam os nomes dos PDFs
# exportados pelo Nidek RS-3000 Advance (como os PDFs de exemplo
# enviados: "MACULA MAP OD ...pdf", "DISC MAP ...pdf", etc.).
NOMES_ARQUIVOS_SIMULADOS = [
    "PACIENTE_EXEMPLO_MACULA MAP OD 03-06-26.pdf",
    "PACIENTE_EXEMPLO_MACULA MAP OE 03-06-26.pdf",
    "PACIENTE_EXEMPLO_DISC MAP 03-06-26.pdf",
    "PACIENTE_EXEMPLO_MACULA RADIAL 03-06-26.pdf",
    "PACIENTE_EXEMPLO_MACULA LINE 03-06-26.pdf",
    "PACIENTE_EXEMPLO_ANGIO OCT OD 03-06-26.pdf",
    "PACIENTE_EXEMPLO_ANGIO OCT OE 03-06-26.pdf",
]


def main():
    print("=" * 70)
    print("TESTE DE PONTA A PONTA — Laudo Nidek RS-3000 Advance (dados fictícios)")
    print("=" * 70)

    caminho_config = PASTA_PRINCIPAL / "config_nidek.json"
    caminho_template = PASTA_PRINCIPAL / "template_laudo_nidek.docx"
    caminho_dados_exemplo = PASTA_EXEMPLO / "dados_exemplo_nidek.json"

    caminho_docx_saida = PASTA_EXEMPLO / "laudo_exemplo_nidek.docx"
    caminho_json_saida = PASTA_EXEMPLO / "laudo_exemplo_nidek_dados.json"
    ...
    try:
        ...
        print("\n" + "=" * 70)
        print("SUCESSO! O laudo do equipamento Nidek está funcionando corretamente.")
        ...
        print(
            ...
            "testar a extração real a partir de PDFs de um exame Nidek, use a "
            "interface gráfica (main.py) ou o aplicativo web, escolhendo "
            "'Nidek RS-3000 Advance' no seletor de equipamento."
        )
